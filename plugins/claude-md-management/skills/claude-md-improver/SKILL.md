...
|------|----------|---------|
| Project memory | `./CLAUDE.md` or `./.claude/CLAUDE.md` | Team-shared instructions (checked into git) |
| Project rules | `./.claude/rules/*.md` | Modular, topic-specific project instructions |
| Local overrides | `./.claude.local.md` | Personal/local settings (gitignored, not shared) |
| User memory | `~/.claude/CLAUDE.md` | User-wide defaults across all projects |
| User rules | `~/.claude/rules/*.md` | Personal modular preferences |
| Package-specific | `./packages/*/CLAUDE.md` | Module-level context in monorepos |

**Rules Frontmatter:**

Rules files support path-specific loading via frontmatter:
...
> **Note**: `paths:` uses comma-separated format, NOT YAML array syntax.
