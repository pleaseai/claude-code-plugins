...
- Path patterns match existing files in codebase
- No overlapping rules with conflicting instructions

### Content Quality

- Clear, specific instructions for the targeted paths
- No duplication with main CLAUDE.md
...
- Using YAML array syntax: `paths: [a, b]` (wrong)
- Paths that don't match any files
- Overly broad rules that should be in CLAUDE.md
- Conflicting instructions between rules
...
- Rules with invalid `paths:` frontmatter syntax
