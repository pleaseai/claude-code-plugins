---
name: deno-frontend
description: Use when building a web frontend with Deno — running React, Vite,
  Astro, SvelteKit, Next.js, Nuxt or other npm frameworks under Deno, or working
  with Fresh, Deno's own island-architecture framework. Covers which path to
  pick, Fresh 2.x routes, handlers, islands, Preact signals, Tailwind, and Fresh
