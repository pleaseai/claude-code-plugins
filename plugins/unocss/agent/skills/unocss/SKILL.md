---
name: unocss
description: UnoCSS instant atomic CSS engine, superset of Tailwind CSS. Use
  when configuring UnoCSS, writing utility rules, shortcuts, or working with
  presets like Wind, Icons, Attributify.
metadata:
  author: Anthony Fu
  version: 2026.1.28
  source: Generated from https://github.com/unocss/unocss, scripts located at
